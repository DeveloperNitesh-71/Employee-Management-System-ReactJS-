...
const Navbar = ({logo, name, loggedInUserData, logoutUser}) => {
  const logout = () => {
  ...
  return (
    <div className='flex items-center justify-between px-5 border-b border-b-gray-200 py-2'>
        ...
        <div className='bg-green-700 text-white font-medium p-1 rounded-full h-8 w-8 flex items-center justify-center'>{logo}</div>
