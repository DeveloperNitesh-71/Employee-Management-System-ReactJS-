      ...
      <form className="grid lg:grid-cols-2 grid-cols-1 lg:place-items-end items-center  p-5 h-max border" onSubmit={handleSubmit}>
        <div className="flex flex-col gap-4 w-full">
          ...
          <div className="flex flex-col items-start">
            ...
            <input type="text" id="Assign-to" placeholder="Employee Name" className="border w-[400px] px-2 py-1 rounded outline-none cursor-pointer" value={assignTo} onChange={(e) => setAssignTo(e.target.value)}/>
          </div>
          <div className="flex flex-col items-start"> 
